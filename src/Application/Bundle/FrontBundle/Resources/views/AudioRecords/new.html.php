...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        function hideFields() {
            var fields = ['uniqueId_lbl', 'location_lbl', 'reformattingPriority_lbl', 'alternateId_lbl', 'title_lbl', 'collectionName_lbl', 'description_lbl', 'commercial_lbl', 'diskDiameters_lbl', 'reelDiameters_lbl', 'mediaDiameters_lbl', 'bases_lbl', 'contentDuration_lbl', 'mediaDuration_lbl', 'creationDate_lbl', 'contentDate_lbl', 'isReview_lbl', 'recordingSpeed_lbl', 'tapeThickness_lbl', 'slides_lbl', 'trackTypes_lbl', 'monoStereo_lbl', 'noiceReduction_lbl', 'genreTerms_lbl', 'contributor_lbl', 'part_lbl', 'generation_lbl', 'copyrightRestrictions_lbl', 'duplicatesDerivatives_lbl', 'relatedMaterial_lbl', 'conditionNote_lbl', 'generalNote_lbl', 'parentCollection_lbl', 'digitized_lbl', 'transcription_lbl', 'digitizedBy_lbl', 'digitizedWhen_lbl', 'urn_lbl', 'add_images','accessLevel_lbl'];
            if ($('#mediaType').val() == '' || $('#project').val() == '' || $('#format').val() == '') {
                for (i = 0; i < fields.length; i++) {
                    $('#' + fields[i]).hide();
                }
            } else {
                var fields1 = ['uniqueId_lbl', 'alternateId_lbl', 'reformattingPriority_lbl', 'location_lbl', 'title_lbl', 'collectionName_lbl', 'description_lbl', 'commercial_lbl', 'contentDuration_lbl', 'mediaDuration_lbl', 'creationDate_lbl', 'contentDate_lbl', 'isReview_lbl', 'genreTerms_lbl', 'contributor_lbl', 'generation_lbl', 'part_lbl', 'copyrightRestrictions_lbl', 'duplicatesDerivatives_lbl', 'relatedMaterial_lbl', 'conditionNote_lbl', 'generalNote_lbl', 'parentCollection_lbl', 'digitized_lbl', 'transcription_lbl', 'add_images','accessLevel_lbl'];
