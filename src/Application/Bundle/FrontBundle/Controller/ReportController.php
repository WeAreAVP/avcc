...
class ReportController extends Controller
{
    ...
    public function openreelaudioAction()
    {
        ...
        $shpinxInfo = $this->container->getParameter('sphinx_param');
        $sphinxSearch = new SphinxSearch($em, $shpinxInfo);
        $criteria = array('s_format' => array('1/4 Inch Open Reel Audio'),
            's_format' => array('1/2 Inch Open Reel Audio'),
            's_format' => array('1/2 Inch Open Reel Audio - Digital'),
            's_format' => array('1 Inch Open Reel Audio'),
            's_format' => array('2 Inch Open Reel Audio'));
