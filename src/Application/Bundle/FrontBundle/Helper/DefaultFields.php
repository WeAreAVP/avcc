...
class DefaultFields {
    ...
    public function getDefaultOrder() {
        $this->defaultOrder['audio'] = array(
            "Media_Type" => array("title" => 'Media Type', 'field' => "record.mediaType", "is_required" => 1, "hidden" => 1),
            "Project_Name" => array("title" => 'Project Name', 'field' => "record.project", "is_required" => 1, "hidden" => 1),
            "Unique_Id" => array("title" => 'Unique Id', 'field' => "record.uniqueId", "is_required" => 1, "hidden" => 1),
            "Alternate_Id" => array("title" => 'Alternate Id', 'field' => "record.alternateId", "is_required" => 0, "hidden" => 1),
            ...
            "Disk_Diameter" => array("title" => 'Disk Diameter', 'field' => "diskDiameters", "is_required" => 0, "hidden" => 1),
            "Reel_Diameter" => array("title" => 'Reel Diameter', 'field' => "record.reelDiameters", "is_required" => 0, "hidden" => 1),
            "Media_Diameter" => array("title" => 'Media Diameter', 'field' => "mediaDiameters", "is_required" => 0, "hidden" => 1),
            "Base" => array("title" => 'Base', 'field' => "bases", "is_required" => 0, "hidden" => 1),
            "Content_Duration" => array("title" => 'Content Duration', 'field' => "record.contentDuration", "is_required" => 0, "hidden" => 1),
            "Media_Duration" => array("title" => 'Media Duration', 'field' => "mediaDuration", "is_required" => 0, "hidden" => 1),
            "Creation_Date" => array("title" => 'Creation Date', 'field' => "record.creationDate", "is_required" => 0, "hidden" => 1),
            "Content_Date" => array("title" => 'Content Date', 'field' => "record.contentDate", "is_required" => 0, "hidden" => 1),
            "Manager_Review" => array("title" => 'Manager Review', 'field' => "record.isReview", "is_required" => 0, "hidden" => 1),
            "General_Notes" => array("title" => 'General Notes', 'field' => "record.generalNote", "is_required" => 0, "hidden" => 1),
            "Reformatting_Priority" => array("title" => 'Reformatting Priority', 'field' => "record.reformattingPriority", "is_required" => 0, "hidden" => 1),
            "Recording_Speed" => array("title" => 'Recording Speed', 'field' => "recordingSpeed", "is_required" => 0, "hidden" => 1),
            "Tape_Thickness" => array("title" => 'Tape Thickness', 'field' => "tapeThickness", "is_required" => 0, "hidden" => 1),
            "Slides" => array("title" => 'Sides', 'field' => "slides", "is_required" => 0, "hidden" => 1),
            "Track_Type" => array("title" => 'Track Type', 'field' => "trackTypes", "is_required" => 0, "hidden" => 1),
            "Mono_Stereo" => array("title" => 'Mono or Stereo', 'field' => "monoStereo", "is_required" => 0, "hidden" => 1),
            "Noice_Reduction" => array("title" => 'Noise Reduction', 'field' => "noiceReduction", "is_required" => 0, "hidden" => 1),
            "Gener_Terms" => array("title" => 'Genre Terms', 'field' => "record.genreTerms", "is_required" => 0, "hidden" => 1),
            "Contributor" => array("title" => 'Contributor', 'field' => "record.contributor", "is_required" => 0, "hidden" => 1),
            "Gerneration" => array("title" => 'Generation', 'field' => "record.generation", "is_required" => 0, "hidden" => 1),
            "Part" => array("title" => 'Part', 'field' => "record.part", "is_required" => 0, "hidden" => 1),
            "Copyright" => array("title" => 'Copyright', 'field' => "record.copyrightRestrictions", "is_required" => 0, "hidden" => 1),
        ...
        $this->defaultOrder['video'] = array(
            ...
            "Description" => array("title" => 'Description', 'field' => "record.description", "is_required" => 0, "hidden" => 1),
            "Commercial" => array("title" => 'Commercial', 'field' => "record.commercial", "is_required" => 0, "hidden" => 1),
            "Cassette_Size" => array("title" => 'Cassette Size', 'field' => "cassetteSize", "is_required" => 0, "hidden" => 1),
            "Reel_Diameter" => array("title" => 'Reel Diameter', 'field' => "record.reelDiameters", "is_required" => 0, "hidden" => 1),
            "Content_Duration" => array("title" => 'Content Duration', 'field' => "record.contentDuration", "is_required" => 0, "hidden" => 1),
            "Media_Duration" => array("title" => 'Media Duration', 'field' => "mediaDuration", "is_required" => 0, "hidden" => 1),
            "Creation_Date" => array("title" => 'Creation Date', 'field' => "record.creationDate", "is_required" => 0, "hidden" => 1),
            ...
            "General_Notes" => array("title" => 'General Notes', 'field' => "record.generalNote", "is_required" => 0, "hidden" => 1),
            "Reformatting_Priority" => array("title" => 'Reformatting Priority', 'field' => "record.reformattingPriority", "is_required" => 0, "hidden" => 1),
            "Format_Version" => array("title" => 'Format Version', 'field' => "formatVersion", "is_required" => 0, "hidden" => 1),
            "Recording_Speed" => array("title" => 'Recording Speed', 'field' => "recordingSpeed", "is_required" => 0, "hidden" => 1),
            "Recording_Standard" => array("title" => 'Recording Standard', 'field' => "recordingStandard", "is_required" => 0, "hidden" => 1),
            "Gener_Terms" => array("title" => 'Genre Terms', 'field' => "record.genreTerms", "is_required" => 0, "hidden" => 1),
            "Contributor" => array("title" => 'Contributor', 'field' => "record.contributor", "is_required" => 0, "hidden" => 1),
            "Gerneration" => array("title" => 'Generation', 'field' => "record.generation", "is_required" => 0, "hidden" => 1),
            "Part" => array("title" => 'Part', 'field' => "record.part", "is_required" => 0, "hidden" => 1),
        ...
        $this->defaultOrder['film'] = array(
            ...
            "Description" => array("title" => 'Description', 'field' => "record.description", "is_required" => 0, "hidden" => 1),
            "Commercial" => array("title" => 'Commercial', 'field' => "record.commercial", "is_required" => 0, "hidden" => 1),
            "Reel_Core" => array("title" => 'Reel or Core', 'field' => "reelCore", "is_required" => 0, "hidden" => 1),
            "Reel_Diameter" => array("title" => 'Reel Diameter', 'field' => "record.reelDiameters", "is_required" => 0, "hidden" => 1),
            "Footage" => array("title" => 'Footage', 'field' => "footage", "is_required" => 0, "hidden" => 1),
            "Media_Diameter" => array("title" => 'Media Diameter (inches)', 'field' => "mediaDiameter", "is_required" => 0, "hidden" => 1),
            "Base" => array("title" => 'Base', 'field' => "bases", "is_required" => 0, "hidden" => 1),
            "Color" => array("title" => 'Color', 'field' => "colors", "is_required" => 0, "hidden" => 1),
            "Sound" => array("title" => 'Sound', 'field' => "sound", "is_required" => 0, "hidden" => 1),
            "Edge_Code/_Year" => array("title" => 'Edge Code/ Year', 'field' => "edgeCodeYear", "is_required" => 0, "hidden" => 1),
            "Content_Duration" => array("title" => 'Content Duration', 'field' => "record.contentDuration", "is_required" => 0, "hidden" => 1),
            "Creation_Date" => array("title" => 'Creation Date', 'field' => "record.creationDate", "is_required" => 0, "hidden" => 1),
            "Content_Date" => array("title" => 'Content Date', 'field' => "record.contentDate", "is_required" => 0, "hidden" => 1),
            "Manager_Review" => array("title" => 'Manager Review', 'field' => "record.isReview", "is_required" => 0, "hidden" => 1),
            "General_Notes" => array("title" => 'General Notes', 'field' => "record.generalNote", "is_required" => 0, "hidden" => 1),
            "Reformatting_Priority" => array("title" => 'Reformatting Priority', 'field' => "record.reformattingPriority", "is_required" => 0, "hidden" => 1),
            "Frame_Rate" => array("title" => 'Frame Rate', 'field' => "frameRate", "is_required" => 0, "hidden" => 1),
            "Acid_Detection_Strip" => array("title" => 'Acid Detection Strip', 'field' => "acidDetectionStrip", "is_required" => 0, "hidden" => 1),
            "Shrinkage" => array("title" => 'Shrinkage', 'field' => "shrinkage", "is_required" => 0, "hidden" => 1),
            "Gener_Terms" => array("title" => 'Genre Terms', 'field' => "record.genreTerms", "is_required" => 0, "hidden" => 1),
            "Contributor" => array("title" => 'Contributor', 'field' => "record.contributor", "is_required" => 0, "hidden" => 1),
            "Gerneration" => array("title" => 'Generation', 'field' => "record.generation", "is_required" => 0, "hidden" => 1),
            "Part" => array("title" => 'Part', 'field' => "record.part", "is_required" => 0, "hidden" => 1),
...
//			$tableView[$mainIndex][] = '<a href="' . $url . '">' . $value['title'] . '</a>';
    ...
    public function paidOrganizations($id, $em = null) {
        ...
        if ((int) $id == 239) {
            ...
            $expiry = strtotime("1st September 2020");
