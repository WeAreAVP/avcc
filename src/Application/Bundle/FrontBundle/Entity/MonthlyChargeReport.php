 ...
 * MonthlyCharges
 *
 * @ORM\Table(name="monthly_charge_report")
 * @ORM\Entity(repositoryClass="Application\Bundle\FrontBundle\Entity\MonthlyChargeReportRepository")
 * @ORM\HasLifecycleCallbacks
 */
class MonthlyChargeReport {
