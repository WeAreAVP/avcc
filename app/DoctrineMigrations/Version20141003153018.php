 ...
 */
class Version20141003153018 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE users ADD organization_id INT DEFAULT NULL, DROP updated_by, DROP created_by');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE users ADD created_by INT DEFAULT NULL, CHANGE organization_id updated_by INT DEFAULT NULL');
